...
def Main(args):
    ...
    def open_student_window(student_data):
        ...
        button_action = tk.Button(new_window, text="拍照", width=10, height=2, command=capture_image, font=("Helvetica", 30))
        button_action.pack()
        ...
        new_window.protocol("WM_DELETE_WINDOW", lambda: [cap.release(), cv2.destroyAllWindows(), new_window.destroy()])
